...
1. **Danny 用户视角端到端演习**（碰头前，产品不动）：从零自己开一个新工作区走全程，
   记录「卡在哪、哪一步不知道该点哪」当清单，演习后再定修哪些。
   （原「三亚 demo 脚本」一项已取消——0807 Danny 拍板，不做讲稿。）
2. **gap2 战役三票已开、全排碰头后**（0807 grill 五拍板，档案 `.issues/gap2-0807/tickets.md`）：
   ...
   三票互相独立；明确不开票：邮件通道、03 表指标卡、模板版本快照、议事室引用命名（仍等拍板）。
