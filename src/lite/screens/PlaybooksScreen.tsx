...
export function PlaybooksScreen() {
  ...
  const slots = [
    t.lite.playbooksSlotRoster,
    t.lite.playbooksSlotIncident,
    t.lite.playbooksSlotPack,
  ]
  ...
  return (
    <section className="scene scene-nexus is-active lite-playbooks" aria-label="Playbooks">
      <section className="nexus-empty lite-playbooks-empty" aria-label="Playbooks — coming soon">
        ...
        <div className="lite-playbooks-slots" aria-label={t.lite.playbooksSlotLabel}>
          <p className="eyebrow lite-playbooks-slots-label">{t.lite.playbooksSlotLabel}</p>
        ...
        <p className="lite-playbooks-comingsoon">{t.lite.playbooksComingSoon}</p>
      </section>
    </section>
  )
}
