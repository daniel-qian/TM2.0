...
export const zh: Dict = {
  ...
  "lite2": {
    ...
    "followupsEmptyActive": "跟进列表还是空的——可以下面加一条,或者把今早的清单、会议上的事、随手一问挪过来。",
    "followupsEmptyHistory": "还没有已完成项——做完的事会落到这里。",
    "followupsSourceTriage": "来自今早",
    "followupsSourceRoom": "来自会议",
    "followupsSourceAsk": "来自随手一问",
    ...
    "closerLookEyebrow": "即将上线",
    "closerLookTitle": "档案和判断对不上的时候",
    "closerLookBody": "项目自己写出来的状态是一回事，背后卡点讲的又是另一回事——这时会在这里冒出一张对照卡：一边是档案上的说法，一边是信号上的说法，可以直接去化解，或者直接去问那位同事。",
    "closerLookComingSoon": "还没做出来——这个 Tab 是边界感的一个预告，故意先把话挑明。",
    "playbooksEyebrow": "即将推出",
    "playbooksTitle": "操作手册从团队已有的工作方式中生长出来",
    "playbooksBody": "当 Avery 接入了你自己的 SOP、检查清单和过往决策后，会把它们提炼成可复用的操作手册——下次遇到类似情况，会议室已经知道你的行事规则。",
    "playbooksSlotRoster": "入职与交接的 SOP 自动转成一步步可执行的操作手册。",
    ...
    "detailSource": "出处：你上传的文件",
    "detailGone": "这张卡片已不在你上传的文件里。",
    "footerText": "Avery 只帮你把账算清楚，不替你拍板。里头的每一条，都得你亲自过一遍再当结论；涉及到岗位、薪酬、员工去留这种大事，不能只靠它来定。"
  },
  "ask": {
    "eyebrow": "快问",
    "draftTitle": "值得直接问问他们",
