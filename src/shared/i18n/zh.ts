...
export const zh: Dict = {
  ...
  "lite2": {
    ...
    "onboardBrowse": "先随便看看",
    // onboarding-accounts-0805 ③（ADR-0034）：头部 badge 是一句产品立场——Avery 只吃结构化的
    // 管理信息，不吃截图、聊天记录、自由格式文档。与标准表单说明页第一段同一个口径。
    // 🔴 短是硬要求：它与步数、右上「先随便看看」共用一行（英文侧的长版本实测被从词中间切断）。
    "onboardStructuredBadge": "只接受结构化信息",
    // 预览模式（拍板 8）。横幅常驻、不可关：它是"你现在在预览"的唯一可见证据，可关的话
    // 用户会在一个自己以为在填真表的界面里输入半小时。
    "onboardPreviewBanner": "页面预览模式：可以直接查看全部步骤；未填写的数据不会保存，也不会用于分析。",
    "onboardPreviewExit": "退出页面预览",
    "onboardPreviewStepNote": "预览模式下不上传文件。想真正把材料交进来，先退出预览。",
    "onboardPreviewFieldNote": "预览模式——这一格不会送到任何地方。",
    ...
    "onboardDoorUploadBody": "把花名册、计划、周报交给 Avery——它会读成一张能用的图。五步走完。",
    // 第三扇门（拍板 8）。它不依赖任何后端能力，所以也是"探测全挂了"时仍然存在的那条路。
    "onboardDoorPreviewTitle": "先看看每一步",
    "onboardDoorPreviewBody": "五个页面都能翻一遍，什么都不用填。不保存、不发送，看完再正式开始。",
    "onboardChipIntake": "数据包",
    "onboardChipTools": "工作工具",
    "onboardChipScope": "管理范围",
    "onboardChipPrefs": "管理偏好",
    "onboardChipAccount": "管理者账号",
    ...
    // ② 连接日常工作工具（拍板 9）。🔴 那句"暂未开通连接"必须与卡片同屏、同等份量：
    // 点亮一张卡什么都没连上，屏幕就得在点击发生的地方说清楚。
    "onboardToolsTitle": "你们的工作，平时都在哪些工具里？",
    "onboardToolsBody": "告诉 Avery 消息、审批和数字现在都在哪儿——这决定接下来先做哪一块。",
    "onboardToolsHonesty": "目前还没有开通任何连接。勾选只是登记一下你的需求，只存在这台浏览器里；今天不会从这些工具里读走任何东西。",
    "onboardToolWecomTitle": "企业微信",
    "onboardToolWecomBody": "同步消息与协作信号。",
    "onboardToolFeishuTitle": "飞书",
    "onboardToolFeishuBody": "文档、审批与日程。",
    "onboardToolDingtalkTitle": "钉钉",
    "onboardToolDingtalkBody": "考勤、审批与消息。",
    "onboardToolOaTitle": "OA 系统",
    "onboardToolOaBody": "流程审批与通知。",
    "onboardToolBiTitle": "BI 数据平台",
    "onboardToolBiBody": "经营数据与报表。",
    "onboardToolCrmTitle": "CRM 客户系统",
    "onboardToolCrmBody": "客户信息与跟进记录。",
    "onboardScopeTitle": "你在管的是什么？",
    "onboardScopeBody": "这里的字段用于产品里的招呼语，仅保存在本浏览器——只有最后那一格例外：它会交给 Avery，让它的判读从你们公司的现实出发。",
    ...
    // ④ 管理偏好：合伙人的 5 个管理框架（拍板 9）。与「操作手册」屏那 8 项目录并列不互斥：
    // 那 8 项讲"你的 SOP 会长成什么"，这 5 项讲"你习惯用哪套管理语言"。
    "onboardPrefsTitle": "你习惯怎么带团队？",
    "onboardPrefsBody": "挑你本来就在用的那几套。Avery 写东西的时候，会用你熟悉的说法。",
    "onboardPrefsHonesty": "这些选择只存在这台浏览器里，不会改变 Avery 读材料的方式——它只影响 Avery 跟你说话时用的词。",
    "onboardFrameworkGoalTitle": "目标拆解与对齐",
    "onboardFrameworkGoalBody": "OKR/KPI 往下拆，以及保底和冲刺两档怎么看。",
    "onboardFrameworkCoachingTitle": "1:1 与辅导",
    "onboardFrameworkCoachingBody": "固定的一对一时间，用来带人而不是对进度。",
    "onboardFrameworkFairnessTitle": "公平理论与激励",
    "onboardFrameworkFairnessBody": "团队里付出与回报是不是对得上。",
    "onboardFrameworkRaciTitle": "RACI 与协作边界",
    "onboardFrameworkRaciBody": "谁拍板、谁执行、谁需要被知会。",
    "onboardFrameworkGapTitle": "现实差距检测",
    "onboardFrameworkGapBody": "汇报上来的说法和实际数据对不上的时候，早点看见。",
    // ⑤ 管理者账号（feat-053 真 Supabase，票 #43 实装）。可跳过是设计而非将就：游客路径是
    ...
    "onboardDoneFrameworksLead": "你习惯的管理方式：",
    "onboardDoneToolsLead": "你告诉我们的工具：",
    "onboardDoneNoPicks": "什么都没挑 —— 这些之后都能再改。",
