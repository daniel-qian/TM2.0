...
export const zh: Dict = {
  ...
  "lite2": {
    ...
    "roomCanvasHint": "拖动平移 · 滚动缩放",
    "roomCanvasReset": "重置视图",
    "followupsEyebrow": "即将推出",
    "followupsTitle": "你跟进的，全在一处",
    "followupsBody": "早班分诊、当场记录、临时请求和多看一眼里的事项，都会落到这里——按今天、本周、稍后分组，每一条都标着出处。",
    "followupsComingSoon": "尚未上线——这个标签页是跟进区未来的样子，先看一眼。",
