...
export const en = {
  ...
  lite2: {
    ...
    decisionRules: {
      ...
      'R-STALE-EVIDENCE': { title: 'Even the newest file on hand was uploaded over {days} days ago, and nothing newer has been read since', basis: 'When the files were uploaded' },
