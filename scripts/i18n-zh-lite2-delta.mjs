...
4. 命名走锁定词族（0729 大白话命名 ADR-0031 后的现行词表）：Today「今天」/ Team「团队」/ Ask Avery「问 Avery」/ To-do list「待办清单」/ Worth noting「值得注意」/ What's coming「完整版预告」/ Follow-ups「跟进」/ 待办动作一律「加到待办」。不得出现「现实差距/差距/gap」「Nexus」字样，也不要复活旧词「多看一眼/议事室/指挥室/未来方向/实录笔记」。
